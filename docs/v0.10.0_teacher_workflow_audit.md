...
- Audited Git SHA: `268fe0ab6f3d74848bf71f1aa1b939adbe242452`
- Quillan version: `0.9.0`
- Python version: `3.14.1`
- Installed `pds-core` version: `0.6.0`
- Audit operating system: `Windows 11`
- Audit generated at (UTC): `2026-08-19T21:19:01+00:00`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| assignment creation | 20 | 15 | 14 | 1 | 0 | 0 | 1 | 1 |
| assignment validation | 5 | 5 | 4 | 2 | 0 | 0 | 1 | 1 |
| repeated assignment creation | 39 | 29 | 28 | 2 | 1 | 10 | 1 | 2 |
| printable-response generation | 7 | 9 | 8 | 1 | 0 | 0 | 2 | 1 |
| complete scan intake | 3 | 4 | 3 | 0 | 0 | 0 | 2 | 0 |
| partial scan intake | 4 | 4 | 3 | 0 | 0 | 0 | 2 | 0 |
| Core scan review | 14 | 14 | 13 | 0 | 0 | 0 | 2 | 3 |
| route selection/correction | 9 | 9 | 8 | 0 | 0 | 0 | 1 | 3 |
| post-dispatch review | 4 | 4 | 3 | 0 | 0 | 0 | 2 | 1 |
| successful retry | 6 | 7 | 6 | 0 | 0 | 0 | 1 | 3 |
| assignment dashboard | 8 | 7 | 5 | 2 | 0 | 0 | 2 | 1 |
| full diagnostic dashboard | 3 | 3 | 2 | 0 | 0 | 0 | 1 | 1 |
| student selection | 11 | 10 | 8 | 3 | 0 | 0 | 3 | 1 |
| class-set student handoff | 14 | 13 | 11 | 4 | 1 | 0 | 4 | 1 |
| complete individual review | 77 | 61 | 35 | 3 | 0 | 0 | 8 | 13 |
| plain-paper creation | 14 | 13 | 11 | 3 | 0 | 0 | 3 | 2 |
| evidence opening | 16 | 15 | 13 | 3 | 0 | 0 | 3 | 2 |
| page selection and page management | 16 | 16 | 14 | 3 | 0 | 0 | 3 | 2 |
| minimum requirements | 27 | 20 | 12 | 3 | 0 | 0 | 4 | 4 |
| review units | 17 | 13 | 10 | 3 | 0 | 0 | 3 | 2 |
| observations | 27 | 21 | 12 | 3 | 0 | 0 | 4 | 3 |
| ratings | 24 | 21 | 12 | 3 | 0 | 0 | 4 | 3 |
| feedback composition | 20 | 18 | 12 | 3 | 0 | 0 | 3 | 2 |
| teacher notes | 14 | 12 | 10 | 3 | 0 | 0 | 3 | 2 |
| workflow-state changes | 15 | 12 | 10 | 3 | 0 | 0 | 3 | 2 |
| feedback export | 14 | 13 | 10 | 3 | 0 | 0 | 3 | 2 |
| assignment-report export | 13 | 11 | 9 | 2 | 0 | 0 | 3 | 2 |
| help | 5 | 5 | 4 | 0 | 0 | 0 | 0 | 2 |

### Key derived baselines

- Initial assignment creation: **20 prompts / 15 screens / 14 transitions**.
- Two substantially similar assignments in one session: **39 prompts / 29 screens**, including **10 repeated configuration decisions** and **1 context reselection**.
- Marginal second similar assignment within that measured session: **19 additional prompts / 14 additional screens / 14 additional transitions**. This subtraction is a
  descriptive comparison, not an independent workflow measurement.
- Single-student selection journey: **11 prompts / 10 screens**.
- Two-student class-set handoff journey: **14 prompts / 13 screens**. Relative to the single-student path, reaching the second
  student adds **3 prompts / 3 screens / 3 transitions**, plus **1 context reselection** and **1 additional student selection**.
- One continuous complete individual-review journey: **77 prompts / 61 screens / 35 transitions** from evidence opening through explicit minimum-requirement disposition, observations, ratings, feedback completion, and Markdown export.
- One student feedback-export journey: **14 prompts / 13 screens**.
- One assignment-report export journey: **13 prompts / 11 screens**.
...
| --- | ---: | ---: | ---: |
| evidence opening | 16 | 15 | 13 |
| minimum requirements | 27 | 20 | 12 |
| review units | 17 | 13 | 10 |
| observations | 27 | 21 | 12 |
| ratings | 24 | 21 | 12 |
| feedback composition | 20 | 18 | 12 |
| workflow-state changes | 15 | 12 | 10 |
| feedback export | 14 | 13 | 10 |

### Recovery paths

| Recovery workflow | Prompts | Screens | Transitions | Backtracking |
| --- | ---: | ---: | ---: | ---: |
| partial scan intake | 4 | 4 | 3 | 2 |
| Core scan review | 14 | 14 | 13 | 2 |
| route selection/correction | 9 | 9 | 8 | 1 |
| post-dispatch review | 4 | 4 | 3 | 2 |
| successful retry | 6 | 7 | 6 | 1 |
| partial scan intake | 4 | 4 | 3 | 2 |
| workflow-state changes | 15 | 12 | 10 | 3 |
| plain-paper creation | 14 | 13 | 11 | 3 |
...
3. **A complete ordinary review requires repeated returns to the selected-student
   ...
   **77 prompts / 61 screens** while moving through
...
| --- | --- | --- | --- | --- |
| Similar assignments repeat setup | high-frequency workflow friction | repeated-assignment journey: 10 repeated configuration decisions | repeated entry of stable review configuration | copying/presets must still require explicit review before save |
...
| Complete review is split across stage submenus | high-frequency workflow friction | complete individual review: 77 prompts / 61 screens | repeated menu traversal within every fully reviewed submission | preserve explicit teacher decisions at each judgment-bearing stage |
